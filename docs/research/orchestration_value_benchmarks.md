...
But several current skills ask subagents to orient themselves by reading standard artifacts such as `DECISIONS.md`, `ARCHITECTURE.md`, and `PLAN.md` under various conditions. citeturn14view1turn15view0turn15view1
